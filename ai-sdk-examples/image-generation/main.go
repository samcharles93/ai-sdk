...
func printDocs() {
	...
	fmt.Println("  - provider/azure/   — Azure OpenAI (AZURE_API_KEY + AZURE_ENDPOINT)")
	fmt.Println("  - provider/togetherai/ — TogetherAI (TOGETHER_API_KEY)")
	fmt.Println("  - provider/xai/     — xAI (XAI_API_KEY)")
	fmt.Println()
