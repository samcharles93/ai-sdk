...
//
// DefaultReadLines bounds the line count but not the value: the first 400
// lines of a 1,500-line file are mostly imports and whichever declarations
// happen to sort first, which is rarely what the model was looking for. An
// index of the whole file plus a targeted follow-up read is both cheaper and
// more likely to land on the right code.
